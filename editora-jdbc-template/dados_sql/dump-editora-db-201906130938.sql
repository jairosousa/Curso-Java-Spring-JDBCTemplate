...
INSERT INTO `livros` VALUES (1,'Aprenda Java Jackarta em 60 dias',1,195),(2,'Quando chegar a hora',1,220),(3,'SEJA UM YOUTUBER DE SUCESSO',1,156),(4,'Ciência de Dados com Javascript',1,680),(5,'Aprenda JSE em 40 dias',2,202),(6,'Tudo tem seu preço',1,360),(7,'Tudo sobre Jogos on line',1,95),(8,'Spring Boot na veia',1,450),(9,'Tudo tem seu preço',2,368),(10,'Tudo sobre Jogos on line',2,105);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `procedure_info` */;
...
in in_id int,
out out_titulo varcharacter(45),
out out_autor varcharacter(45),
out out_editora varcharacter(45)
)
begin
	select
...
/*!50003 DROP PROCEDURE IF EXISTS `procedure_uppercase_titulo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2019-06-13  9:38:19
